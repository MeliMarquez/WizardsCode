...
func _ready():
	...
	hide()
	print("Iniciando el spell mixer")
...
func _on_combine():
	if left_selection and right_selection:
		spell_result.texture = load("res://assets/images/spells/64x64_FX_11.png")
		arrow_3.hide()
		set_next_step()
...
func set_next_step():
	...
	if self.step == 1:
		...
		animation_player.play("label2")
		await animation_player.animation_finished
		arrow_3.show()
		animation_player.play("arrow_left")
		combine.disabled = false
	elif self.step == 3:
		animation_player.play("label3")
		await animation_player.animation_finished
		arrow_4.show()
		animation_player.play("arrow_left")
...
func set_first_spell():
	spell_one.texture_normal = load("res://assets/images/spells/64x64_Aura_6.png")
